...
VALUES
  ...
  (
    'd1000000-0000-0000-0000-000000000001',
    'c1000000-0000-0000-0000-000000000002', -- Missouri City Campus
    false
  )
...
VALUES
  (
    ...
    '2000-01-15',
    'c1000000-0000-0000-0000-000000000001', -- North Campus
    'p1000000-0000-0000-0000-000000000001', -- Class A Barber
    'active',
    '2025-01-06',
    '2025-01-13',
    '2025-07-15',
...
VALUES
  ('s1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000001', CURRENT_DATE - INTERVAL '1 day', (CURRENT_DATE - INTERVAL '1 day')::date + TIME '09:00', (CURRENT_DATE - INTERVAL '1 day')::date + TIME '17:00', 8.0, 8.0, 2.0, 6.0, 'present'),
  ('s1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000001', CURRENT_DATE - INTERVAL '2 days', (CURRENT_DATE - INTERVAL '2 days')::date + TIME '09:00', (CURRENT_DATE - INTERVAL '2 days')::date + TIME '17:00', 8.0, 8.0, 2.5, 5.5, 'present'),
  ('s1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000001', CURRENT_DATE - INTERVAL '3 days', (CURRENT_DATE - INTERVAL '3 days')::date + TIME '09:00', (CURRENT_DATE - INTERVAL '3 days')::date + TIME '17:00', 8.0, 8.0, 2.0, 6.0, 'present'),
  ('s1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000001', CURRENT_DATE - INTERVAL '4 days', (CURRENT_DATE - INTERVAL '4 days')::date + TIME '09:15', (CURRENT_DATE - INTERVAL '4 days')::date + TIME '16:45', 8.0, 7.5, 2.0, 5.5, 'present')
...
VALUES
  ('w1000000-0000-0000-0000-000000000001', 'f1000000-0000-0000-0000-000000000001', 'pell_grant', 'Federal Pell Grant', 'federal', 7395.00, 7395.00, 'accepted'),
  ('w1000000-0000-0000-0000-000000000002', 'f1000000-0000-0000-0000-000000000001', 'direct_sub', 'Direct Subsidized Loan', 'federal', 3500.00, 1955.00, 'accepted')
ON CONFLICT (id) DO NOTHING;
