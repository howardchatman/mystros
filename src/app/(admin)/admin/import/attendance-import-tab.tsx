...
import { importAttendance, type ImportResult } from "@/lib/actions/import";

const REQUIRED_HEADERS = ["student_number", "date", "clock_in", "clock_out"];
const ALL_HEADERS = [...REQUIRED_HEADERS, "hours", "type"];

export function AttendanceImportTab() {
  ...
  const handleImport = () => {
    startTransition(async () => {
      const res = await importAttendance(parsedRows as any);
      setResult(res);
    });
  };
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Required columns: {REQUIRED_HEADERS.join(", ")}. Optional: hours, type (theory/practical)
              </p>
            </div>
            <a href="/templates/attendance-import-template.csv" download>
